...
public class GridDragMenuActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        toolbar.setTitle("可拖拽的Grid列表");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        niceRecyclerView = (NiceRecyclerView) findViewById(R.id.recycler_view);
        niceRecyclerView.setLayoutManager(new GridLayoutManager(this, 2));// 布局管理器。
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener = new OnSwipeMenuItemClickListener() {
        ...
        public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                ...
                Toast.makeText(context, "当前菜单的第" + (adapterPosition + 1) + "项; " +
