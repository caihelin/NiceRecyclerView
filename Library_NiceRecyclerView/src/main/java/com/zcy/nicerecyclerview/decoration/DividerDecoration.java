package com.zcy.nicerecyclerview.decoration;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof HeaderAndFooterWrapper) {
            headerCount = ((HeaderAndFooterWrapper) parent.getAdapter()).getHeadersCount();
            footerCount = ((HeaderAndFooterWrapper) parent.getAdapter()).getFootersCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof HeaderAndFooterWrapper) {
            headerCount = ((HeaderAndFooterWrapper) parent.getAdapter()).getHeadersCount();
            footerCount = ((HeaderAndFooterWrapper) parent.getAdapter()).getFootersCount();
            dataCount = ((HeaderAndFooterWrapper) parent.getAdapter()).getRealItemCount();
        } else {
